...
questions = [
    ("На сколько дней составить план питания (от 1 до 7 дней)?", "days"),
...
def generate_meal_plan(answers, days=1):
    ...
    prompt = (
        ...
        "Требования: баланс БЖУ, 2000–2500 ккал на взрослого в день; ингредиенты — строго на 1 порцию в граммах/мл (без «по вкусу»); обед — 2 блюда + напиток.\n\n"
        "Формат по дням:\n"
        "📝 План питания\n"
        "\n"
        "🗓 День X\n"
        "🍳 Завтрак: [блюдо]. Ингредиенты: [ингр. — N г, …]."    
        "🍲 Обед: [блюдо 1]: […]; [блюдо 2]: […]. Напиток: [название].\n"    
...
def edit_meal_plan(answers, current_plan, change_request):
    ...
    prompt = (
        ...
        "\n"
        "🗓 День X\n"
        "🍳 Завтрак: [блюдо]. Ингредиенты: [ингр. — N г, …]. Время: N мин.\n"
        "🍲 Обед: [блюдо 1]: […]; [блюдо 2]: […]. Напиток: [название].\n"
        "🥗 Ужин: [блюдо]. Ингредиенты: […]. Время: N мин."   
    )
    try:
